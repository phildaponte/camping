...
$(document).foundation(),$("#menu-mobile").mmenu(),$("#menu-mobile-infos").mmenu({offCanvas:{position:"right"}}),$("#tab-mobile").headroom({offset:100}),window.setTimeout(function(){$(".block-image.lazy").find("img").unveil(200,function(){$(this).load(function(){this.style.opacity=1})})},300);var lightbox=$(".lightbox").imageLightbox({onStart:function(){ilbOverlayOn(),ilbNavigationOn(lightbox)},onEnd:function(){ilbCaptionOff(),ilbOverlayOff(),ilbActivityIndicatorOff(),ilbNavigationOff()},onLoadStart:function(){ilbCaptionOff(),ilbActivityIndicatorOn()},onLoadEnd:function(){ilbCaptionOn(lightbox),ilbActivityIndicatorOff()}});$(".sticky-position").sticky(),awstatsMiscTracker.init();